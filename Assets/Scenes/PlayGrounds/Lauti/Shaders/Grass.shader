...
Shader "Grass"
{
	Properties
	{
		...
		_SubstractRadius("SubstractRadius", Float) = 0
		_SubstracPJ("SubstracPJ", Float) = 0
		_Mascara("Mascara", Float) = 1.08
		_Seepdgras("Seepdgras", Float) = 2
		[ASEEnd]_Vectoraltura("Vector altura", Vector) = (0.5,0,0.5,0)
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Grass_ST;
			float3 _Vectoraltura;
			float3 _MyPos;
			float _Mascara;
			float _Seepdgras;
			float _SubstracPJ;
			float _Radius;
			float _SubstractRadius;
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float mulTime16 = _TimeParameters.x * _Seepdgras;
				float2 texCoord19 = v.texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_cast_0 = (_SubstracPJ).xxx;
				float temp_output_26_0 = ( saturate( ( distance( ase_worldPos , _MyPos ) / _Radius ) ) - _SubstractRadius );
				float3 appendResult31 = (float3(temp_output_26_0 , 0.0 , temp_output_26_0));
				float3 lerpResult34 = lerp( ( ( 1.0 - ( ase_worldPos.y * _Mascara ) ) * ( sin( mulTime16 ) + texCoord19.x ) * _Vectoraltura ) , ( ( 1.0 - _MyPos ) - temp_cast_0 ) , appendResult31);
				...
				#endif
				float3 vertexValue = lerpResult34;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float2 uv_Grass = IN.ase_texcoord7.xy * _Grass_ST.xy + _Grass_ST.zw;
				float4 tex2DNode8 = tex2D( _Grass, uv_Grass );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float3 ase_worldPos = mul(GetObjectToWorldMatrix(), v.vertex).xyz;
				float mulTime16 = _TimeParameters.x * _Seepdgras;
				float2 texCoord19 = v.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float3 temp_cast_0 = (_SubstracPJ).xxx;
				float temp_output_26_0 = ( saturate( ( distance( ase_worldPos , _MyPos ) / _Radius ) ) - _SubstractRadius );
				float3 appendResult31 = (float3(temp_output_26_0 , 0.0 , temp_output_26_0));
				float3 lerpResult34 = lerp( ( ( 1.0 - ( ase_worldPos.y * _Mascara ) ) * ( sin( mulTime16 ) + texCoord19.x ) * _Vectoraltura ) , ( ( 1.0 - _MyPos ) - temp_cast_0 ) , appendResult31);
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 uv_Grass = IN.ase_texcoord3.xy * _Grass_ST.xy + _Grass_ST.zw;
				float4 tex2DNode8 = tex2D( _Grass, uv_Grass );
...
/*ASEBEGIN
Version=18900
414;-11;1920;1013;1223.852;-889.0638;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;9;-1815.114,404.7963;Inherit;False;499.9932;410.2519;Posición del jugador;3;14;11;10;;1,1,1,1;0;0
Node;AmplifyShaderEditor.WorldPosInputsNode;11;-1756.121,636.049;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;10;-1765.113,454.7967;Inherit;False;Property;_MyPos;MyPos;1;0;Create;True;0;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;12;-1338.149,1656.36;Inherit;False;Property;_Seepdgras;Seepdgras;6;0;Create;True;0;0;0;False;0;False;2;2.91;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DistanceOpNode;14;-1500.145,505.7058;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-1366.485,955.8706;Inherit;False;Property;_Radius;Radius;2;0;Create;True;0;0;0;False;0;False;0;1.56;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;17;-1507.46,2188.176;Inherit;False;752.2188;245.6584;Podríamos utilizarlo para usar una misma dirección para todos los pastos. Es decir, viento;1;20;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;15;-1535.41,1797.569;Inherit;False;461;200;Utilizando este nodo podemos generar una máscara;1;19;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;18;-1207.672,686.1317;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleTimeNode;16;-1169.306,1696.742;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-1222.466,1453.612;Inherit;False;Property;_Mascara;Mascara;5;0;Create;True;0;0;0;False;0;False;1.08;1.87;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;20;-1225.28,2254.834;Inherit;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.SaturateNode;24;-772.6216,671.7775;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;22;-865.5017,833.5974;Inherit;False;Property;_SubstractRadius;SubstractRadius;3;0;Create;True;0;0;0;False;0;False;0;-0.3;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;19;-1402.086,1856.5;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SinOpNode;23;-977.2885,1693.802;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;29;-788.358,1159.291;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;35;-457.5859,1139.885;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector3Node;25;-712.8694,1372.495;Inherit;False;Property;_Vectoraltura;Vector altura;7;0;Create;True;0;0;0;False;0;False;0.5,0,0.5;2.81,0,2.03;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;28;-1166.084,424.6366;Inherit;False;Property;_SubstracPJ;SubstracPJ;4;0;Create;True;0;0;0;False;0;False;0;0.71;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;30;-637.6292,1728.956;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;27;-1604.889,164.4215;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;26;-589.6822,654.3187;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;32;-149.2929,1266.825;Inherit;True;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.DynamicAppendNode;31;-484.5819,489.1389;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;33;-958.2936,264.3571;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;34;-250.5501,270.7412;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;8;-988.5675,-126.5535;Inherit;True;Property;_Grass;Grass;0;0;Create;True;0;0;0;False;0;False;-1;None;0c1f0ffc76327d342aed76562d6cd8b0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;Grass;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;2;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;0;0;False;True;1;5;False;-1;10;False;-1;1;1;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;2;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;0;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;1;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=92A28A85C1BBD6AF61A3988E8F6CB6E57C8BB3B5